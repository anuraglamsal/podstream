...
# hese imports are here because of a circular-import problem.
...
# path of the web app is done under this function.
     ...
     # class that we inherited in our 'SignUp' class.
          ...
          user = User(firstname=up.FirstName.data, middlename=up.MiddleName.data, lastname=up.LastName.data, email=up.email.data,
...
def login():
     ...
     if log.validate_on_submit():
          ...
          if user and bcrypt.check_password_hash(user.password, log.Password.data):
               ...
               flash('''The user doesn't exist. Check your credentials or sign up by clicking on 'Sign Up'.''')
